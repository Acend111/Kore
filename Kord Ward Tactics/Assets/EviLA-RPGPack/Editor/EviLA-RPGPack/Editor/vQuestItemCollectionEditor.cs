...
namespace EviLA.AddOns.RPGPack
{
    ...
    [CustomEditor(typeof(vQuestItemCollection))]
    public class vQuestItemCollectionEditor : Editor
    {
        vQuestItemCollection manager;
        ...
        protected virtual void OnEnable()
        {
            ...
            manager = (vQuestItemCollection)target;
        ...
        public override void OnInspectorGUI()
        {
            ...
            GUILayout.BeginVertical("Quest Item Collection", "window");
